 ...
 * the Super Admin, or self-upgraded via Stripe) — moved here from the
 * sidebar's "Packages & Modules" (now the agency's own package-CREATION
 * page for ITS customers, see Pages/Agency/AgencyPackagesPage.jsx). Content
