                    ...
                    <form onSubmit={handleLogin}>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="relative">
                                <input
                                    className="shadow-sm appearance-none border rounded-lg w-full py-3 px-4 pr-12 text-gray-700 mb-3 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    id="password"
                        ...
                        <div className="flex items-center justify-center">
                            <input
                                className="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg focus:outline-none focus:shadow-outline cursor-pointer"
                                type="submit"
                                value="Log In" />
                        </div>
                    </form>
